...
document.getElementById("buttonOne").style.backgroundColor = "lightBlue"
document.getElementById("one").style.margin = "20px"
document.getElementById("one").style.padding = "10px"
document.getElementById("resultOne").style.padding = "10px"

document.getElementById("buttonTwo").style.backgroundColor = "lightPink"
document.getElementById("two").style.margin = "20px"
document.getElementById("two").style.padding = "10px"
document.getElementById("resultTwo").style.padding = "10px"

document.getElementById("buttonThree").style.backgroundColor = "lightGreen"
document.getElementById("three").style.margin = "20px"
document.getElementById("three").style.padding = "10px"
document.getElementById("resultThree").style.padding = "10px"